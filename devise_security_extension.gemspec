...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/devise_security_extension/models/active_record/old_password.rb",
    "lib/devise_security_extension/models/active_record/security_question.rb",
    "lib/devise_security_extension/models/mongoid/security_question.rb",
    "lib/devise_security_extension/models/mongoid/old_password.rb",
